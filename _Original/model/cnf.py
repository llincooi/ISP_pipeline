...
class CNF:
    ...
    def __init__(self, img, bayer_pattern, thres, gains, clip):
        self.img = img
    ...
    def cnc(self, is_color, center, avgG, avgC1, avgC2):
        ...
        r_gains = self.gains[0]
        gr_gains = self.gains[1]
        gb_gains = self.gains[2]
        b_gains = self.gains[3]
        dampFactor = 1.0
    ...
    def cnd(self, y, x, img):
        ...
        avgC2 = avgC2 / 16
        center = img[y, x]
        if center > avgG + self.thres and center > avgC2 + self.thres and avgC1 > avgG + self.thres and avgC1 > avgC2 + self.thres:
                is_noise = 1
